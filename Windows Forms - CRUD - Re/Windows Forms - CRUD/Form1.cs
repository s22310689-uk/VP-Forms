    ...
    // NOTE : The table name is table-vp
{
    public partial class Form1 : Form
    {
        ...
        private void Button_Search(object sender, EventArgs e)
        {
            ...
            {
                koneksi.Open();
                query = "SELECT * FROM `table-vp` WHERE First_Name LIKE @search OR Last_Name LIKE @search";
        ...
        private void Button_Update(object sender, EventArgs e)
        {
            try
            {
                if (ID.Text != "")
                {
                    ...
                    query = string.Format(
                        "UPDATE `table-vp` SET First_Name='{0}', Last_Name='{1}', Gender='{2}', BirthDate='{3}' WHERE ID={4}",
        ...
        private void Button_Insert(object sender, EventArgs e)
        {
            try
            {
                ...
                if (FirstName.Text != "" && LastName.Text != "" && (Male.Checked || Female.Checked)) {
                    ...
                    // Query
                    query = string.Format("INSERT INTO `table-vp` (First_Name, Last_Name, Gender, BirthDate) VALUES ('{0}', '{1}', '{2}', '{3}')", FirstName.Text, LastName.Text, gender, birthdate);
